...
\begin{itemize}
	...
	\item \textbf{TSL2561:} Digital ambient-light sensor for
	      visible and IR light~\cite{tsl2561_datasheet}.
	\item \textbf{Bosch BME680:} Comprehensive sensor for precise
	      temperature, humidity, pressure, and VOC gas concentrations~\cite{bme680_bosch, esp32_bme680_randomnerdtutorials}.
