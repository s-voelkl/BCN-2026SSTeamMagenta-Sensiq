...
\begin{figure*}[!tb]
	\centering
	\includegraphics[width=0.8\textwidth]{../../kicad-hardware-schematic/circuit_diagram_pdf/circuit_diagram_export_light.pdf}
...
\begin{lstlisting}[
    language=json, 
    float, 
    caption={Published JSON payload by the ESP32 sensor node via the 
